...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        for idx, (attn, resnet) in enumerate(zip(self.attentions, self.resnets[1:])):
            hidden_states, mapscores, cross_attention_query_features = attn(
                hidden_states,
        ...
        return hidden_states, mapscores_dict, cross_attention_query_features
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        ...
        attn_scores = {}
        cross_attention_query_features_list = []
        for idx, (resnet, attn) in enumerate(zip(self.resnets, self.attentions)):
            if self.training and self.gradient_checkpointing:
                ...
                cross_attention_query_features_list.append(cross_attention_query_features)
        ...
        return hidden_states, output_states, attn_scores, cross_attention_query_features_list
...
class CrossAttnUpBlock2D(nn.Module):
    ...
    def forward(
        ...
        return hidden_states, attn_scores, cross_attention_query_features_list
